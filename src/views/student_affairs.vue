  ...
  <div class="flex-grow">
    ...
    <section 
      ...
      <div class="mx-10 md:py-20 py-16 text-white relative z-10 flex flex-col">
        <h1 class="md:text-4xl text-xl font-bold mb-4 font-serif animate-slideIn">Student Affairs</h1>
        <p class="md:text-xl text-sm mb-8 font-serif animate-fadeIn delay-1s">The Office of Student Affairs is dedicated to addressing the needs and
    ...
    <div class="bg-indigo-100 py-8 font-serif animate-fadeIn">
      ...
      <section class="py-8 p-4 animate-popIn">
        <div class="bg-white rounded-lg shadow-md">
          <h2 class="text-xl md:text-3xl text-center font-bold p-3 rounded-t-lg bg-gradient-to-r from-blue-500 to-cyan-300 animate-fadeInUp">Description</h2>
          <div class="font-medium text-lg md:text-xl p-4 space-y-2 animate-fadeIn delay-2s">
      ...
      <section class="py-8 p-4 animate-popIn">
        <div class="bg-white rounded-lg shadow-md">
          <h2 class="text-xl md:text-3xl text-center font-bold p-3 rounded-t-lg bg-gradient-to-r from-blue-500 to-cyan-300 animate-fadeInUp">Re-Admission</h2>
          <div class="font-medium text-lg md:text-xl p-4 animate-fadeIn delay-2s">
      ...
      <section class="py-8 p-4 animate-popIn">
        <div class="bg-white rounded-lg shadow-md">
          <h2 class="text-xl md:text-3xl text-center font-bold p-3 rounded-t-lg bg-gradient-to-r from-blue-500 to-cyan-300 animate-fadeInUp">Scholarships</h2>
          <div class="font-medium text-lg md:text-xl p-4 animate-fadeIn delay-2s">
      ...
      <section class="py-8 p-4 animate-popIn">
        <div class="bg-white rounded-lg shadow-md">
          <h2 class="text-xl md:text-3xl text-center font-bold p-3 rounded-t-lg bg-gradient-to-r from-blue-500 to-cyan-300 animate-fadeInUp">Fees Details</h2>
          <div class="font-medium text-lg md:text-xl p-4 animate-fadeIn delay-2s">
      ...
      <section class="py-8 p-4 animate-popIn">
        <div class="bg-white rounded-lg shadow-md">
          <h2 class="text-xl md:text-3xl text-center font-bold p-3 rounded-t-lg bg-gradient-to-r from-blue-500 to-cyan-300 animate-fadeInUp">Contact Us</h2>
          <div class="font-medium text-lg md:text-xl p-4 animate-fadeIn delay-2s">
            <div class="space-y-2">
