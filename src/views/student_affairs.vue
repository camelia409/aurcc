      ...
      <div class="w-full">
        ...
        >
          <div v-if="section.key === 'description'" class="grid grid-cols-1">
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden transition-all duration-300 hover:shadow-md">
              <div class="bg-gradient-to-r from-indigo-600 to-blue-500 py-6">
                <h2 class="text-2xl md:text-3xl text-white font-bold text-center">Description</h2>
              </div>
          ...
          <div v-else-if="section.key === 'reAdmission'" class="grid grid-cols-1">
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden transition-all duration-300 hover:shadow-md">
              <div class="bg-gradient-to-r from-indigo-600 to-blue-500 py-6">
                <h2 class="text-2xl md:text-3xl text-white font-bold text-center">Re-Admission</h2>
              </div>
              <div class="p-6 md:p-8">
                <p class="text-gray-700 leading-relaxed whitespace-pre-line">{{ content['Re-Admission'] }}</p>
              </div>
            </div>
          </div>
          <div v-else-if="section.key === 'scholarships'" class="grid grid-cols-1">
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden transition-all duration-300 hover:shadow-md">
              <div class="bg-gradient-to-r from-indigo-600 to-blue-500 py-6">
                <h2 class="text-2xl md:text-3xl text-white font-bold text-center">Scholarships</h2>
              </div>
              <div class="p-6 md:p-8">
          ...
          <div v-else-if="section.key === 'fees'" class="grid grid-cols-1">
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden transition-all duration-300 hover:shadow-md">
              <div class="bg-gradient-to-r from-indigo-600 to-blue-500 py-6">
                <h2 class="text-2xl md:text-3xl text-white font-bold text-center">Fees Details</h2>
              </div>
              <div class="p-6 md:p-8">
                <a :href="content['fees details']" target="_blank" class="text-blue-600 underline">{{ content['fees details'] }}</a>
              </div>
            </div>
          </div>
