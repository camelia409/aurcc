<template>
  <OfficePageTemplate
    office-name="Entrepreneurship Development Cell"
    hero-subtitle="Empowering innovation, startups, and entrepreneurial spirit"
    :sections="sections"
    contact-email="edcell@aurcc.ac.in"
