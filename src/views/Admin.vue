<template>
  <div>
    ...
    <div class="container mx-auto p-4 md:p-9">
      ...
      >
        ...
        <div
          v-for="(subsection, subsectionName) in section"
          :key="subsectionName"
          class="mb-8"
        >
          ...
          <div v-if="subsection.DEPUTY_MANAGER" class="mb-8">
            ...
            <div class="flex flex-wrap justify-center gap-4">
              <div
                ...
                :key="member.name"
                class="admin-member bg-white rounded-lg shadow-lg overflow-hidden flex flex-col items-center mx-4 max-w-xs"
              >
                <div class="w-full flex justify-center pt-6">
                  <div class="w-48 h-48 md:w-60 md:h-60 overflow-hidden border-4 border-gray-200">
                    <img
                ...
                <div class="flex-grow flex flex-col justify-center bg-gray-100 text-center w-full p-4">
                  <h2 class="text-xl md:text-2xl font-bold text-black">{{ member.name }}</h2>
          ...
          <div v-if="subsection.STAFFS" class="mb-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              <div
                ...
                :key="member.name"
                class="admin-member bg-white rounded-lg shadow-lg overflow-hidden flex flex-col items-center max-w-xs"
              >
                <div class="w-full flex justify-center pt-6">
                  <div class="w-48 h-48 md:w-60 md:h-60 overflow-hidden border-4 border-gray-200">
                    <img
